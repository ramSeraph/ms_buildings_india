...
def get_partition_info(reader):
    ...
    for i,bucket in enumerate(buckets):
        if from_level == max_level:
            partition_name = f'z{from_level}-part{i}'
        else:
...
if __name__ == '__main__':
    ...
    reader = MBTilesSource('data/ms_buildings_india.mbtiles')
    ...
    mosaic_data = create_pmtiles(partition_info, 'data/ms_buildings_india-', reader)
    pprint(mosaic_data)
